...
rt_s zz_test_deduce_encoding()
{
	...
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("ascii.dat"), RT_ENCODING_US_ASCII, 0, _R("ea"))) goto error;

#ifdef RT_DEFINE_WINDOWS
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("latin1.dat"), RT_ENCODING_SYSTEM_DEFAULT, 0, _R("ιθ"))) goto error;
#else
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("latin1.dat"), RT_ENCODING_ISO_8859_15, 0, _R("ιθ"))) goto error;
#endif

	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_8_with_bom.dat"),    RT_ENCODING_UTF_8,    3, _R("ιθ"))) goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_16LE_with_bom.dat"), RT_ENCODING_UTF_16LE, 2, _R("ιθ"))) goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_16BE_with_bom.dat"), RT_ENCODING_UTF_16BE, 2, _R("ιθ"))) goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_32LE_with_bom.dat"), RT_ENCODING_UTF_32LE, 4, _R("ιθ"))) goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_32BE_with_bom.dat"), RT_ENCODING_UTF_32BE, 4, _R("ιθ"))) goto error;

	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_8_2.dat"),  RT_ENCODING_UTF_8,    0, _R("ιθ")))            goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_8_3.dat"),  RT_ENCODING_UTF_8,    0, (rt_char*)zz_utf8_3)) goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_8_4.dat"),  RT_ENCODING_UTF_8,    0, (rt_char*)zz_utf8_4)) goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_16LE.dat"), RT_ENCODING_UTF_16LE, 0, _R("ιθ")))            goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_16BE.dat"), RT_ENCODING_UTF_16BE, 0, _R("ιθ")))            goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_32LE.dat"), RT_ENCODING_UTF_32LE, 0, _R("ιθ")))            goto error;
	if (!zz_test_deduce_encoding_do(encoding_dir, _R("utf_32BE.dat"), RT_ENCODING_UTF_32BE, 0, _R("ιθ")))            goto error;

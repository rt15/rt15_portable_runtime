 ...
 */
RT_API rt_s rt_select(struct rt_select_item *read_items,  rt_un read_items_size,
...
RT_API rt_s rt_select_wait_for_ready_to_read(struct rt_socket *socket, rt_un timeout_milliseconds);

RT_API rt_s rt_select_wait_for_ready_to_write(struct rt_socket *socket, rt_un timeout_milliseconds);

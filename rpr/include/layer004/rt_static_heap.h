 ...
 */
RT_API void *rt_static_heap_alloc(void **area, rt_un size);
 ...
 */
RT_API void *rt_static_heap_realloc(void **area, rt_un size);
 ...
 * </p>
 */
RT_API rt_s rt_static_heap_free(void **area);
 ...
 */
RT_API void *rt_static_heap_alloc_if_needed(void *buffer, rt_un buffer_capacity, void **heap_buffer, rt_un *heap_buffer_capacity, void **area, rt_un size);

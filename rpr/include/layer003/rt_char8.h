...
#define RT_CHAR8_IS_BLANK(CHARACTER) (CHARACTER <= ' ')
#define RT_CHAR8_IS_LOWER_ALPHA(CHARACTER) (CHARACTER >= 'a' && CHARACTER <= 'z')
#define RT_CHAR8_IS_UPPER_ALPHA(CHARACTER) (CHARACTER >= 'A' && CHARACTER <= 'Z')
#define RT_CHAR8_IS_ALPHA(CHARACTER) (RT_CHAR8_IS_LOWER_ALPHA(CHARACTER) || RT_CHAR8_IS_UPPER_ALPHA(CHARACTER))
#define RT_CHAR8_IS_NUM(CHARACTER) (CHARACTER >= '0' && CHARACTER <= '9')
#define RT_CHAR8_IS_ALPHANUM(CHARACTER) (RT_CHAR8_IS_ALPHA(CHARACTER) || RT_CHAR8_IS_NUM(CHARACTER))

#define RT_CHAR8_FAST_LOWER_CHAR(CHARACTER) (RT_CHAR8_IS_UPPER_ALPHA(CHARACTER) ? CHARACTER + 32 : CHARACTER)
#define RT_CHAR8_FAST_UPPER_CHAR(CHARACTER) (RT_CHAR8_IS_LOWER_ALPHA(CHARACTER) ? CHARACTER - 32 : CHARACTER)
...
RT_API rt_s rt_char8_append_f32(rt_f32 value, rt_un decimal_count, rt_char8 *buffer, rt_un buffer_capacity, rt_un *buffer_size);

RT_API rt_s rt_char8_append_f64(rt_f64 value, rt_un decimal_count, rt_char8 *buffer, rt_un buffer_capacity, rt_un *buffer_size);
 ...
 * @param buffer_size The number of characters in the buffer (in/out parameter).
 */
RT_API rt_s rt_char8_append_hex(const rt_char8 *data, rt_un size, rt_un item_size,
...
RT_API rt_b rt_char8_ends_with(const rt_char8 *str, rt_un str_size, const rt_char8 *searched, rt_un searched_size);

...
#define RT_CHAR_IS_LOWER_ALPHA(CHARACTER) (CHARACTER >= _R('a') && CHARACTER <= _R('z'))
#define RT_CHAR_IS_UPPER_ALPHA(CHARACTER) (CHARACTER >= _R('A') && CHARACTER <= _R('Z'))
#define RT_CHAR_IS_ALPHA(CHARACTER) (RT_CHAR_IS_LOWER_ALPHA(CHARACTER) || RT_CHAR_IS_UPPER_ALPHA(CHARACTER))
#define RT_CHAR_IS_NUM(CHARACTER) (CHARACTER >= _R('0') && CHARACTER <= _R('9'))
#define RT_CHAR_IS_ALPHANUM(CHARACTER) (RT_CHAR_IS_ALPHA(CHARACTER) || RT_CHAR_IS_NUM(CHARACTER))

#define RT_CHAR_FAST_LOWER_CHAR(CHARACTER) (RT_CHAR_IS_UPPER_ALPHA(CHARACTER) ? CHARACTER + 32 : CHARACTER)
#define RT_CHAR_FAST_UPPER_CHAR(CHARACTER) (RT_CHAR_IS_LOWER_ALPHA(CHARACTER) ? CHARACTER - 32 : CHARACTER)
 ...
 * </p>
 */
RT_API rt_s rt_char_convert_to_f32(const rt_char *str, rt_f32 *result);
 ...
 * </p>
 */
RT_API rt_s rt_char_convert_to_f32_with_size(const rt_char *str, rt_un str_size, rt_f32 *result);
 ...
 * </p>
 */
RT_API rt_s rt_char_convert_to_f64(const rt_char *str, rt_f64 *result);
 ...
 * @param buffer_size The number of characters in the buffer (in/out parameter).
 */
RT_API rt_s rt_char_append_eol(enum rt_eol eol, rt_char *buffer, rt_un buffer_capacity, rt_un *buffer_size);
